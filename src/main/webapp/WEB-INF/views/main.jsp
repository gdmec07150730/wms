...
<head>
    ...
    <script type="text/javascript" src="/js/system/index.js" charset="UTF-8"></script>
</head>
<body>
<div id="top">
    <div id="top_logo">
...
<div id="side">
    <div id="left_menu">
        <ul id="TabPage2" style="height:200px; margin-top:50px;">
            ...
            <li id="left_tab2" class="selected" title="系统管理" data-rootmenu="systemManage">
    ...
    <div id="left_menu_cnt">
        ...
        <div id="nav_resource">
            <ul id="dleft_tab1" class="ztree">
                <li><a href="/employee/query.do" target="right">员工管理</a></li>
                <li><a href="/department/query.do" target="right">部门管理</a></li>
                <li><a href="/role/query.do" target="right">角色管理</a></li>
                <li><a href="/permission/query.do" target="right">权限管理</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div id="main">
    <iframe name="right" id="rightMain" src="/employee/query.do" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
</div>
</body>
</html>