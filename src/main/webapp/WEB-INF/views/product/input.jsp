        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select name="brandId" class="ui_select01 brand_select">
                ...
                <%--品牌回显--%>
                <script>
                    $(".brand_select option[value='${product.brandId}']").prop("selected", true);
                </script>
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <c:if test="${not empty product.imagePath}">
                            <img src="${product.imagePath}" class="list_img"/>
